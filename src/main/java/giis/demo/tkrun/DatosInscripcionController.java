 ...
 */
public class DatosInscripcionController {
	private DatosInscripcionModel model;
	private DatosInscripcionView view;
	private String lastSelectedKey=""; //recuerda la ultima fila seleccionada para restaurarla cuando cambie la tabla de carreras

	public DatosInscripcionController(DatosInscripcionModel m, DatosInscripcionView v) {
		this.model = m;
		this.view = v;
	...
	public void initController() {
		...
		view.getBtnTablaInscripcionesAtletas().addActionListener(e -> getListaDatosInscripcionesAtletas());
		//ademas invoco el metodo que responde al listener en el exceptionWrapper para que se encargue de las excepciones
		view.getBtnTablaInscripcionesAtletas().addActionListener(e -> SwingUtil.exceptionWrapper(() -> getListaDatosInscripcionesAtletas()));
		...
		view.getTablaInscripcionesAtletas().addMouseListener(new MouseAdapter() {
			@Override
...
//		view.getListaAtletas().setModel(lmodel);
	...
	public void restoreDetail() {
		...
		this.lastSelectedKey=SwingUtil.selectAndGetSelectedKey(view.getTablaInscripcionesAtletas(), this.lastSelectedKey);
...
//			this.updateDetail();
	...
	public void updateDetail() {
		...
		this.lastSelectedKey=SwingUtil.getSelectedKey(view.getTablaInscripcionesAtletas());
